...
class _AuthCardState extends State<AuthCard> {
  ...
  void _submit() async {
    ...
    try {
      ...
      Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => ProductScreen()));
      ...
      if (e.toString().contains("EMAIL_NOT_FOUND")) {
        ...
        errorMessage = "Your Id has been Disabled";
      } else if (e.toString().contains("EMAIL_EXISTS")) {
        errorMessage = "Email Address already present";
      } else if (e.toString().contains("OPERATION_NOT_ALLOWED")) {
        errorMessage = "sign-in is disabled right now, try again later";
      }
      else{
      ...
      var errorMessage = "Couldn't authenticate you";
      _showErrorDialog(errorMessage);
    }
    setState(() {
      _isLoading = false;
